...
function App() {
  ...
  const startVerification = useCallback(async () => {
    ...
    if (success) {
      ...
      setResult('Failed to verified a proof that a user is older than the minimum age');
    }
  }, [initCompleted]);
    ...
    <div className="App">
      <header className="App-header">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', width: '50%', alignItems: 'center' }}>
          <p>
            Proof verification example using minimum age comparison. By verifying the proof you verify that the (hidden) user's date of birth as timestamp, which is 1669637349 in this case,
            is earlier than the date of minimum age as timestamp, which is 1669637350.
          </p>
