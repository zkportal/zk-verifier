/*
* zk-verifier v2.0.0-rc.0 (https://github.com/zkportal/zk-verifier)
...
(function (global, factory) {
    ...
    * @returns {boolean}
    */
    function verify_proof(verifying_key, proof, public_inputs) {
    ...
    async function init(input) {
        if (typeof input === 'undefined') {
            input = new URL('zk_verifier_bg.wasm', (typeof document === 'undefined' && typeof location === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : typeof document === 'undefined' ? location.href : (document.currentScript && document.currentScript.src || new URL('zk-verifier.umd.js', document.baseURI).href)));
        }
        const imports = getImports();
